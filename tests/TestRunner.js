...
var _user$project$Value$getMonth = function (date) {
...
var _user$project$Value$getDateFromInt = function (timestamp) {
	return _elm_lang$core$Date$fromTime(
		_elm_lang$core$Basics$toFloat(1000 * timestamp));
};
var _user$project$Value$toString = function (value) {
	var _p1 = value;
	switch (_p1.ctor) {
		case 'I':
		...
		case 'S':
			return _p1._0;
		default:
			var date = _user$project$Value$getDateFromInt(_p1._0);
			var day = _elm_lang$core$Basics$toString(
				_elm_lang$core$Date$day(date));
			var month = _user$project$Value$getMonth(date);
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										hours,
										A2(_elm_lang$core$Basics_ops['++'], ':', mins))))))));
	}
};
var _user$project$Value$D = function (a) {
	return {ctor: 'D', _0: a};
};
var _user$project$Value$S = function (a) {
	return {ctor: 'S', _0: a};
};
var _user$project$Value$B = function (a) {
	return {ctor: 'B', _0: a};
};
var _user$project$Value$F = function (a) {
	return {ctor: 'F', _0: a};
};
var _user$project$Value$I = function (a) {
	return {ctor: 'I', _0: a};
};
var _user$project$Value$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Value package Test suite',
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			A2(
				...
				_user$project$Value$toString(
					_user$project$Value$I(23)),
				'23')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Float',
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Value$toString(
					_user$project$Value$D(1468688316)),
				'16 July 2016, 19:58')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'String',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Value$toString(
					_user$project$Value$S('Test string')),
				'Test string'))
		]));
var _user$project$Value$main = {
	main: A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_user$project$Value$toString(
							_user$project$Value$S('Test')))
					]))
			]))
};

var _user$project$Main$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$Value$tests)
};
